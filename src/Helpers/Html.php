...
class Html {
     ...
     * @return void
     */
    public function series_dropdown(array $args = array()): void
    {
        $defaults = array(
     ...
     * @return void
     */
    public function genre_dropdown(array $args = array()): void
    {
        $defaults = array(
     ...
     * @return void
     */
    public function text(array $args = array()): void
    {
        $defaults = array(
            'id'          => '',
            'name'        => '',
     ...
     * @return void
     */
    public function select(array $args = array()): void
    {
        $defaults = array(
            'options'          => array(),
            'name'             => '',
