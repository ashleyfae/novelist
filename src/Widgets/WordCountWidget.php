 ...
 * @license   GPL2+
 */
class WordCountWidget extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Title:', 'novelist'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>">
        </p>

        <p>
            <label for="<?php echo $this->get_field_id('goal'); ?>"><?php esc_html_e('Word Count Goal:', 'novelist'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('current'); ?>">
                <?php esc_html_e('Current Word Count:', 'novelist'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('color'); ?>"><?php esc_html_e('Bar Colour:', 'novelist'); ?></label>
            <br>
        ...
        <p>
            ...
            echo wp_kses(
                __(
                    'Use <mark>[current]</mark> as a placeholder for your current word count, and <mark>[goal]</mark> as a placeholder for your goal.',
                    'novelist'
                ),
                ['mark' => []]
            );
        ...
        <p><strong><?php esc_html_e('Add Text', 'novelist'); ?></strong></p>

        <p>
            <label for="<?php echo $this->get_field_id('text_before'); ?>">
                <?php esc_html_e('Text Before the Bar:', 'novelist'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('text_after'); ?>">
                <?php esc_html_e('Text After the Bar:', 'novelist'); ?>
            </label>
