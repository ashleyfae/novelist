 ...
 * @license   GPL2+
 */
class BooksBySeriesWidget extends WP_Widget
{
            ...
            if ($books->have_posts()) {
                ...
                <ul class="novelist-books-series-list">
                    ...
                    <?php while ($books->have_posts()) : $books->the_post();
                        ...
                        echo apply_filters(
                            'novelist/widget/books-by-series/book-entry',
                            $final_html,
                            $book_obj,
                            $book_title,
                            $series_name
    ...
    public function form($instance)
    {
        ...
        <p>
            <label for="<?php echo $this->get_field_id('series'); ?>">
                <?php esc_html_e('Select a Series:', 'novelist'); ?>
            </label>
            <?php
            $args = array(
        ...
        <p>
            <label for="<?php echo $this->get_field_id('text_before'); ?>">
                <?php esc_html_e('Text before the list:', 'novelist'); ?>
            </label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('text_after'); ?>">
                <?php esc_html_e('Text after the list:', 'novelist'); ?>
            </label>
